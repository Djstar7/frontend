...
// Réactif : changera automatiquement quand userStore.user changera
  ...
  >
    <ul class="space-y-2 relative p-4">
      <li v-for="link in menuLinks" :key="link.name" class="group">
        ...
        >
          <font-awesome-icon :icon="link.icon" class="mr-3 text-lg group-hover:text-blue-600" />
    ...
    <!-- Profil -->
    <div class="relative text-gray-600 mb-20 group bg-blue-100 w-full">
      <router-link
      ...
      >
        <font-awesome-icon
          icon="user"
          class="mr-3 text-xl text-blue-500 group-hover:text-blue-600"
        />
